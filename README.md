...
Website for [autOScan](https://github.com/autoscan-lab/autOScan-tui), a TUI tool for batch compiling, grading, and analyzing C lab submissions.
...
- [autOScan](https://github.com/autoscan-lab/autOScan-tui) - TUI grading tool
